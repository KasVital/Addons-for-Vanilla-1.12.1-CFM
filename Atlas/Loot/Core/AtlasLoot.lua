...
StaticPopupDialogs["ATLASLOOT_OLD_ATLAS"] = {
	text = L["It has been detected that your version of Atlas does not match the version that Atlasloot is tuned for ("]..ATLASLOOT_CURRENT_ATLAS..L["). Depending on changes, there may be the occasional error, so please visit http://www.atlasmod.com as soon as possible to update."],
	button1 = L["OK"],
	OnAccept = function()
		DEFAULT_CHAT_FRAME:AddMessage(BLUE.."AtlasLoot"..": "..RED..L["Incompatible Atlas Detected"])
	end,
	timeout = 0,
	whileDead = 1,
	hideOnEscape = 1
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["WSGRewards"] = {
		...
		{ L["Friendly Reputation Rewards"], "WSGRepFriendly" },
	},
	["ABRewards"] = {
		...
		{ L["Friendly Reputation Rewards"], "ABRepFriendly" },
	},
	["AVRewards"] = {
