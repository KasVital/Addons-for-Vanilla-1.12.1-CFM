AtlasLoot_Data["AtlasLootWorldEvents"] = {
	...
	AbyssalLords = {
		...
		{ 20681, "INV_Bracer_10", "=q3=Abyssal Leather Bracers", "=ds=#s8#, #a2# =q2=#e23#", "24.70%" },
		{ 20680, "INV_Shoulder_16", "=q3=Abyssal Mail Pauldrons", "=ds=#s3#, #a3# =q2=#e23#", "24.21%" },
		{ 0,"","","" },
		{ 0, "INV_Box_01", "=q6=#x91#", "=q1=#j11#" },
		{ 20685, "INV_Jewelry_Necklace_21", "=q4=Wavefront Necklace", "=ds=#s2#", "24.48%" },
		{ 20515, "INV_Staff_13", "=q4=Abyssal Scepter", "=ds=#m3#", "100%" },
		{ 20684, "INV_Bracer_07", "=q3=Abyssal Mail Armguards", "=ds=#s8#, #a3# =q2=#e23#", "27.68%" },
		{ 20683, "INV_Shoulder_22", "=q3=Abyssal Plate Epaulets", "=ds=#s3#, #a4# =q2=#e23#", "21.52%" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		...
		{ 20515, "INV_Staff_13", "=q4=Abyssal Scepter", "=ds=#m3#", "100%" },
		{ 20690, "INV_Bracer_12", "=q3=Abyssal Cloth Wristbands", "=ds=#s8#, #a1# =q2=#e23#", "23.60%" },
		{ 20689, "INV_Shoulder_08", "=q3=Abyssal Leather Shoulders", "=ds=#s3#, #a3# =q2=#e23#", "23.40%" },
		{ 0,"","","" },
	...
	ElementalInvasion = {
		...
		{ 0,"","","" },
		{ 0, "INV_Box_01", "=q6=#x42#", "=q1=#j11#, #zone8#" },
		...
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0, "INV_Box_01", "=q6=#x93#", "=q1=#j12#, #zone9#" },
		...
		{ 0,"","","" },
		{ 0, "INV_Box_01", "=q6=#x7#", "=q1=#j13#, #zone10#" },
	...
	Valentineday = {
		...
		{ 22261, "INV_Crate_03", "=q1=Love Fool", "=ds=#m20#" },
	...
	Winterviel1 = {
		...
		{ 0,"","","" },
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6=#m35#", "" }, 
		...
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6=#m34#", "" },
		{ 21328, "INV_Wand_02", "=q1=Wand of Holiday Cheer", "=ds=#m20#" },
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6=#m33#", "" }, 
	...
	HarvestFestival = {
		...
		{ 20010, "INV_Misc_Book_06", "=q1=The Horde's Hellscream", "=q1=#m4# =ds=#m20# =q6=#m6#" },
		{ 0,"","","" },
	...
	LunarFestival1 = {
		...
		{ 0,"","","" },
		{ 0, "INV_Misc_LuckyMoneyEnvelope", "=q6=#m31#", "" },
		{ 21744, "INV_Misc_MissileLargeCluster_White", "=q1=Lucky Rocket Cluster", "=ds=#m15#" },
		{ 21745, "INV_Misc_Gem_Pearl_04", "=q1=Elder's Moonstone", "=ds=#m20#" },
		{ 0,"","","" },
		{ 21540, "INV_Misc_Lantern_01", "=q2=Elune's Lantern", "=q1=#m4# =ds=#m20#" },
		{ 21536,"INV_Misc_Gem_Pearl_04","=q1=Elune Stone","=ds=#m20#" },
		{ 0, "INV_Box_02",  "=q6=#m30#", "=ds=#m15#" },
		{ 21558, "INV_Misc_MissileSmall_Blue", "=q1=Small Blue Rocket", "=ds=#m15#" },
		{ 21559, "INV_Misc_MissileSmall_Green", "=q1=Small Green Rocket", "=ds=#m15#" },
		{ 21557, "INV_Misc_MissileSmall_Red", "=q1=Small Red Rocket", "=ds=#m15#" },
		{ 21561, "INV_Misc_MissileSmall_White", "=q1=Small White Rocket", "=ds=#m15#" },
		{ 21562, "INV_Misc_MissileSmall_Yellow", "=q1=Small Yellow Rocket", "=ds=#m15#" },
		{ 21589, "INV_Misc_MissileLarge_Blue", "=q1=Large Blue Rocket", "=ds=#m15#" },
		{ 21590, "INV_Misc_MissileLarge_Green", "=q1=Large Green Rocket", "=ds=#m15#" },
		{ 21592, "INV_Misc_MissileLarge_Red", "=q1=Large Red Rocket", "=ds=#m15#" },
		{ 21593, "INV_Misc_MissileLarge_White", "=q1=Large White Rocket", "=ds=#m15#" },
	...
	MidsummerFestival = {
		...
		{ 23247, "INV_SummerFest_FireFlower", "=q1=Burning Blossom", "=ds=#m20#" },
		{ 23246, "INV_SummerFest_FireDrink", "=q1=Fiery Festival Brew", "=ds=#m20#" },
