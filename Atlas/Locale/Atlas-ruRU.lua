...
ATLAS_DDL_LEVEL_MENU = "Подземелья отсортированы по уровню";
...
ATLAS_DDL_ALL = "Все";
ATLAS_DDL_ALL_MENU = "Показывать все подземелья";
ATLAS_DDL_TYPE = "Типу";
ATLAS_DDL_TYPE_DUNGEONS = "Подземелья";
ATLAS_DDL_TYPE_RAIDS = "Рейды";
ATLAS_DDL_WORLDBOSSES = "Мировые боссы";
ATLAS_DDL_TYPE_ENTRANCE = GREN.."Входы";
ATLAS_DDL_BGS = GREN.."Поля боя";
ATLAS_DDL_DUNGEON_LOCATIONS = GREN.."Расположение подземелий";
ATLAS_DDL_FLIGHT_PATHS = GREN.."Карты полетов";
ATLAS_DDL_LEVELING_GUIDE = "Руководство прокачки";
