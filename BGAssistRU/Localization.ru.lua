...
DISPLAY_MENU_AUTOSHOW 		= "Автоотображение окна при входе на ПБ";
DISPLAY_MENU_AUTORELEASE 		= "Автовоскрешение на ПБ";
DISPLAY_MENU_AUTOQUEST 		= "Автоподтверждение заданий";
DISPLAY_MENU_AUTOENTER 		= "Автовход на ПБ";
DISPLAY_MENU_AUTOSIGNUP 		= "Авто регистрация на ПБ";
...
DISPLAY_MENU_TARGETTINGASSISTANCE = "Использовать окно помощь цели";
DISPLAY_MENU_AUTOACCEPTGROUP 	= "Автопотверждение группы на ПБ";
DISPLAY_MENU_AUTOLEAVEGROUP 	= "Автопокидать группу после завершения ПБ";
DISPLAY_MENU_NOPREEXISTING 	= "Без ранее существовавших экземпляров";
