...
DISPLAY_MENU_MINIMAPBUTTON			= "Show Minimap button"
DISPLAY_MENU_RANKWINDOW				= "Show window with ranks counting"
DISPLAY_MENU_CLASSWINDOWS			= "Show windows with class counting"
...
DISPLAY_TEXT_GRAVEYARD 			= "Graveyard"
DISPLAY_CURRENTCOUNT			= "\nCurrent Count: "
DISPLAY_UNKNOWN					= "(Unknown)"
DISPLAY_MINIMAPTOOLTIP			= "Left-Click for open menu"
DISPLAY_MINIMAPTOOLTIP2			= "Right-Click for move icon"
DISPLAY_TITLEDISPLAY_CAPTURE 	= "Captures"
DISPLAY_TITLEDISPLAY_ITEMS   	= "Items"
DISPLAY_TITLEDISPLAY_TARGETS 	= "Targets"
DISPLAY_RANKSCOUNT 				= "Click for send counting ranks in the BG chat."
