...
function BGAssist_CountPlayers()
	...
	if (players > 0) then
		...
		for i = 1, players, 1 do
			local _, _, _, _, _, faction, rank, _, class = GetBattlefieldScore(i);
			...
			-- if class~=CLASS_DRUID and class~=CLASS_HUNTER and class~=CLASS_MAGE
			-- and class~=CLASS_PALADIN and class~=CLASS_PRIEST and class~=CLASS_ROGUE
			-- and class~=CLASS_WARRIOR and class~=CLASS_WARLOCK and class~=CLASS_SHAMAN then
				-- ace:print(class.." - unknownclass")
			-- end
			...
			if rank then BGAssist_CountedPlayers[faction]["Rank"][rank] = BGAssist_CountedPlayers[faction]["Rank"][rank] + 1
...
function BGAssist_OnLoad()
	...
	BGAssistCfmFrame:SetFrameStrata("TOOLTIP")
	...
	BGAssistCfmFrame:SetScript("OnMouseDown", function(self, button)
		BGAssistCfmFrame:StartMoving()
	end)
	BGAssistCfmFrame:SetScript("OnMouseUp", function(self, button)
		BGAssistCfmFrame:StopMovingOrSizing()
	end)
	--First icon for the HORDE players
	BGAssistCfmFH = CreateFrame("Frame","BGACFHorde", BGAssistCfmFrame)
	...
	--H14
	BGAssistCfmFH14 = CreateFrame("Frame","BGACFHorde14", BGAssistCfmFrame)
	...
	--H13
	BGAssistCfmFH13 = CreateFrame("Frame","BGACFHorde13", BGAssistCfmFrame)
	...
	--H12
	BGAssistCfmFH12 = CreateFrame("Frame","BGACFHorde12", BGAssistCfmFrame)
	...
	--H11
	BGAssistCfmFH11 = CreateFrame("Frame","BGACFHorde11", BGAssistCfmFrame)
	...
	--H10
	BGAssistCfmFH10 = CreateFrame("Frame","BGACFHorde10", BGAssistCfmFrame)
	...
	--H9
	BGAssistCfmFH9 = CreateFrame("Frame","BGACFHorde9", BGAssistCfmFrame)
	...
	--H8
	BGAssistCfmFH8 = CreateFrame("Frame","BGACFHorde8", BGAssistCfmFrame)
	...
	--H7
	BGAssistCfmFH7 = CreateFrame("Frame","BGACFHorde7", BGAssistCfmFrame)
	...
	--H6
	BGAssistCfmFH6 = CreateFrame("Frame","BGACFHorde6", BGAssistCfmFrame)
	...
	--H5
	BGAssistCfmFH5 = CreateFrame("Frame","BGACFHorde5", BGAssistCfmFrame)
	...
	--H4
	BGAssistCfmFH4 = CreateFrame("Frame","BGACFHorde4", BGAssistCfmFrame)
	...
	--H3
	BGAssistCfmFH3 = CreateFrame("Frame","BGACFHorde3", BGAssistCfmFrame)
	...
	--H2
	BGAssistCfmFH2 = CreateFrame("Frame","BGACFHorde2", BGAssistCfmFrame)
	...
	--H1
	BGAssistCfmFH1 = CreateFrame("Frame","BGACFHorde1", BGAssistCfmFrame)
	...
	--H0
	BGAssistCfmFH0 = CreateFrame("Frame","BGACFHorde0", BGAssistCfmFrame)
	...
	BGAssistCfmFA = CreateFrame("Frame","BGACFAlliance", BGAssistCfmFrame)
	...
	--A14
	BGAssistCfmFA14 = CreateFrame("Frame","BGACFAlliance14", BGAssistCfmFrame)
	...
	--A13
	BGAssistCfmFA13 = CreateFrame("Frame","BGACFAlliance13", BGAssistCfmFrame)
	...
	--A12
	BGAssistCfmFA12 = CreateFrame("Frame","BGACFAlliance12", BGAssistCfmFrame)
	...
	--A11
	BGAssistCfmFA11 = CreateFrame("Frame","BGACFAlliance11", BGAssistCfmFrame)
	...
	--A10
	BGAssistCfmFA10 = CreateFrame("Frame","BGACFAlliance10", BGAssistCfmFrame)
	...
	--A9
	BGAssistCfmFA9 = CreateFrame("Frame","BGACFAlliance9", BGAssistCfmFrame)
	...
	--A8
	BGAssistCfmFA8 = CreateFrame("Frame","BGACFAlliance8", BGAssistCfmFrame)
	...
	--A7
	BGAssistCfmFA7 = CreateFrame("Frame","BGACFAlliance7", BGAssistCfmFrame)
	...
	--A6
	BGAssistCfmFA6 = CreateFrame("Frame","BGACFAlliance6", BGAssistCfmFrame)
	...
	--A5
	BGAssistCfmFA5 = CreateFrame("Frame","BGACFAlliance5", BGAssistCfmFrame)
	...
	--A4
	BGAssistCfmFA4 = CreateFrame("Frame","BGACFAlliance4", BGAssistCfmFrame)
	...
	--A3
	BGAssistCfmFA3 = CreateFrame("Frame","BGACFAlliance3", BGAssistCfmFrame)
	...
	--A2
	BGAssistCfmFA2 = CreateFrame("Frame","BGACFAlliance2", BGAssistCfmFrame)
	...
	--A1
	BGAssistCfmFA1 = CreateFrame("Frame","BGACFAlliance1", BGAssistCfmFrame)
	...
	--A0
	BGAssistCfmFA0 = CreateFrame("Frame","BGACFAlliance0", BGAssistCfmFrame)
...
function BGAssist_UpdateTimers()
	...
	if (not BGAssistRU_Config.timerhide and status == "active") then
		...
		for name in BGAssist_MapItems do
			if (BGAssist_MapItems[name].conflictstart or (BGAssistRU_Config.showcapturedflags and BGAssist_InBattleGround == ARATHIBASIN)) then
				local endtime = BGAssist_MapItems[name].conflictstart + BGAssist_MapItems[name].conflictduration;
				local timeleft = endtime - GetTime();
				if (timeleft > 0 or (BGAssistRU_Config.showcapturedflags and BGAssist_InBattleGround == ARATHIBASIN)) then
...
function BGAssist_Item_SetTooltip()
	if (this.item and BGAssist_ItemInfo[this.item] and BGAssist_ItemInfo[this.item].name) then
		local txt = BGAssist_ItemInfo[this.item].name.."\nТекущее количество: "..BGAssist_TrackedItems[this.item];
