...
SH_SET_YOUR_KEYBINDINGS_LABEL="Note: Set your hotkeys in [Option Menu]->[Key Bindings] or commands\n /smh hot1, /smh hot2 or /smh hot3"
...
SH_HIDE_HP_GREATER_THAN_100="Hide Unit hp>100%"
...
if ( GetLocale() == "deDE" ) then
    ...
    SH_AUTOTARGET_HOTKEY2="AutoTarget Hotkey 2"
    SH_AUTOTARGET_HOTKEY3="AutoTarget Hotkey 3"
    SH_SET_YOUR_KEYBINDINGS_LABEL="Note: Setzt eure Hotkeys unter [Hauptmen\195\188]->[Tastenbelegung] or commands\n /smh hot1, /smh hot2 or /smh hot3"
    ...
    SH_HIDE_HP_GREATER_THAN_100="Fellma\195\159einheit hp>100%"
...
SH_RANK="Уровень";
SH_SPELL_NOT_AVAILABLE="SmartHeal недоступен с этой способностью!";
SH_OVERHEAL="Сверхлечение";
SH_SET_TO="установлен в";
SH_IS_NOT_ACTIVE_CLASS="SmartHeal неактивен для вашего класса.";
SH_IS_ACTIVE="SmartHeal активен."
...
SH_MANA="Мана: (%d+)";
SH_SMARTHEAL_OPTION="SmartHeal - настройка";
SH_EXCESSIVE_HEALING_ALERT_MSG="Избыточное исцеление на"
SH_DISABLED="Выключен"
-- Bindings.xml
BINDING_HEADER_SMARTHEAL_AUTO_TARGET	= "SmartHeal - Автоцель";
...
SH_ENABLE_SMARTHEAL="Вкл. SmartHeal"
SH_SHOW_MINIMAP_BUTTON="Показывать кнопку на миникарте"
SH_OVERHEAL_LABEL="% Сверхлечения, 110=сверхлечение, 90=не полное лечение"
...
SH_OVERDRIVE_MODE="Overdrive режим (Принуд. высший ур.)"
...
SH_AUTOTARGET_HOTKEY1="Автоцель \nГорячая клавиша 1"
SH_AUTOTARGET_HOTKEY2="Автоцель \nГорячая клавиша 2"
SH_AUTOTARGET_HOTKEY3="Автоцель \nГорячая клавиша 3"
SH_SET_YOUR_KEYBINDINGS_LABEL="Подсказка: установить клавишы [Настройки]->[Назначение клавиш] или командами\n /smh hot1, /smh hot2 или /smh hot3"
...
if ( GetLocale() == "frFR" ) then
	...
	SH_HIDE_HP_GREATER_THAN_100="Unit\195\169 de peau  hp>100%"
