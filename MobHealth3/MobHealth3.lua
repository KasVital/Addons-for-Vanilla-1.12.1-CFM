...
function MobHealth3:OnInitialize()
	...
	self:RegisterChatCommand({"/mobhealth3cl", "/mh3cl"}, self.options)
	self:RegisterChatCommand({ "/mobhealth3", "/mh3"}, function() waterfall:Open('MobHealth3') end)
	waterfall:Register('MobHealth3', 'aceOptions', self.options, 'title','MobHealth3 3.2. Revision: 12749','colorR', 0.8, 'colorG', 0.6, 'colorB', 0.7) 
