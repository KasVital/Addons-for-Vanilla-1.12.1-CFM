...
klhtm.string.data["ruRU"] = 
{
	...
	["optionsgui"] = {
		...
		["tooltips"] = {
			...
			["raidhide"] = "Если установлен флажек , игроки с нулевым показателем угрозы не будут видны в списке.",
			...
			["aggro"] = "Если установлен флажек, игрок добавляется в дисплей рейда, на котором отображается срыв аггро. Для более точного значения рекомендуется поставить на цель Мастера Цели.",
			["rows"] = "Максимальное количество игроков в листе угрозы.",
			["bottom"] = "Если установлен флажек, будет скрыта нижняя строка.",
		},
	},
	["print"] = 
	{
