...
if ( GetLocale() == "deDE" ) then -- {{{
    ...
    --end added in Rc4
    DCR_LOC_AF_TYPE [DCR_DISEASE] = 'Krankheit';
    DCR_LOC_AF_TYPE [DCR_MAGIC]	  = 'Magie';
    DCR_LOC_AF_TYPE [DCR_POISON]  = 'Gift';
    DCR_LOC_AF_TYPE [DCR_CURSE]	  = 'Fluch';
    DCR_LOC_AF_TYPE [DCR_CHARMED] = 'Verf\195\188hrung';
    ...
    BINDING_NAME_DCROPTION  = "Zeige/Verstecke Einstellungsfenster";
    ...
    DCR_SHOW_TOOLTIP    = "Zeige Tooltips in der Betroffenenliste";
    DCR_REVERSE_LIVELIST= "Zeige die Live-Liste umgekehrt";
    DCR_HIDE_LIVELIST   = "Verstecke die Live-Liste";

    DCR_AMOUNT_AFFLIC   = "Zeige Anzahl der Betroffenen: ";
    DCR_BLACK_LENGTH    = "Sekunden auf der Blacklist: ";
    DCR_SCAN_LENGTH     = "Sekunden zwischen Live-Scans: ";
    ...
    DCR_IGNORE_STEALTH  = "Ignoriere getarnte Einheiten";
    ...
    DCR_DONOT_BL_PRIO   = "Keine Namen der Priorit\195\164tenliste bannen";
    DCR_CHOOSE_CURE	= "Reinige:";
    ...
    DCR_NO_SPELLS        = "Keine Zauber gefunden!";
