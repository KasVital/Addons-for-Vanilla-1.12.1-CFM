...
local function debug(info)
	if Atlas_DebugMode then
		DEFAULT_CHAT_FRAME:AddMessage("[Atlas Turtle-WOW] "..info)
	end
end



ATLAS_VERSION = GetAddOnMetadata("Atlas Turtle-WOW", "Version")
...
function Atlas_Init()
		...
		EarthFeature_AddButton(
			{
				...
				tooltip = ATLAS_DESC,
				icon = "Interface\\AddOns\\Atlas Turtle-WOW\\Images\\AtlasIcon",
	...
	elseif(Cosmos_RegisterButton) then
		Cosmos_RegisterButton(
			...
			ATLAS_SUBTITLE,
			ATLAS_DESC,
			"Interface\\AddOns\\Atlas Turtle-WOW\\Images\\AtlasIcon",
			Atlas_Toggle
		)
	end
...
function Atlas_UpdateLock()
	if(AtlasOptions.AtlasLocked) then
		AtlasLockNorm:SetTexture("Interface\\AddOns\\Atlas Turtle-WOW\\Images\\LockButton-Locked-Up")
		AtlasLockPush:SetTexture("Interface\\AddOns\\Atlas Turtle-WOW\\Images\\LockButton-Locked-Down")
	else
		AtlasLockNorm:SetTexture("Interface\\AddOns\\Atlas Turtle-WOW\\Images\\LockButton-Unlocked-Up")
		AtlasLockPush:SetTexture("Interface\\AddOns\\Atlas Turtle-WOW\\Images\\LockButton-Unlocked-Down")
	end
end
