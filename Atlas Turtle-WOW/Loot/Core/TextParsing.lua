...
function AtlasLoot_FixText(text)
    ...
    text = gsub(text, "#x7#", L["Captain Greenskin"])
    ...
    text = gsub(text, "#x105#", "Marshal Magnus Greystone")
    text = gsub(text, "#x106#", "Genn Greymane")
    text = gsub(text, "#x107#", "High Foreman Bargul Blackhammer")
	...
	text = gsub(text, "#craftbm2#", "Towerforge Battlegear")
	text = gsub(text, "#craftbm3#", "Hateforge Armor")
	text = gsub(text, "#craftbp3#", "Steel Plate")
	text = gsub(text, "#craftbp4#", "Dreamsteel Armor")
	text = gsub(text, "#craftbp5#", "Rune-Etched Armor")
    ...
    text = gsub(text, "#craftlw20#", "Convergence of the Elements")
    ...
    text = gsub(text, "#oth_s25#", "Greymane Armor")
    text = gsub(text, "#oth_s26#", "Incendosaur Skin Armor")
