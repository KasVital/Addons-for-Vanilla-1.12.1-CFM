...
GetSpellInfoVanillaDB = {
	...
	["craftspells"] = {
		...
		[45611] = {
			["name"] = "Agitating Poison I",
			["requires"] = "",
			["tools"] = "",
			["castTime"] = 3,
			["text"] = "Coats a weapon with poison that lasts for 30 minutes. Each strike has a 20% chance of poisoning the enemy which instantly inflicts 67 to 86 Nature damage, and causes additional threat. 115 charges.",
			["craftItem"] = 65032,
			["craftQuantityMin"] = "",
			["craftQuantityMax"] = "",
			["reagents"] = {
