...
-----------------------------------
	...
	PrimalistsTrappings = {
		...
		{ 81066, "Inv_Chest_Plate06", "=q2=Primalist's Vest", "=ds=#s5#, #a2#" }, --285
	},
...
---------------------
	...
	SmithingJourneyman1 = {
		...
		{ "s57166", "INV_Scroll_03", "=q1=Bronze Belt Buckle", "=ds=#sr# =so1=90 =so2=115 =so3=127 =so4=140" },
	...
	SmithingExpert1 = {
		...
		{ "s57172", "INV_Misc_Buckle_04", "=q2=Mithril Belt Buckle", "=ds=#sr# =so1=190 =so2=210 =so3=222 =so4=235" },
	...
	SmithingArtisan2 = {
		...
		{ "s57178", "INV_Misc_Buckle_06", "=q2=Arcanite Belt Buckle", "=ds=#sr# =so1=275 =so2=300 =so3=300 =so4=300" },
	...
	SmithingArtisan4 = {
		...
		{ "s47259", "INV_Gauntlets_09", "=q3=Rune-Etched Grips", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
		{ "s47254", "inv_boots_plate_05", "=q3=Rune-Etched Greaves", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
		{ "s47255", "inv_pants_04", "=q3=Rune-Etched Legplates", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
		{ "s47256", "inv_chest_plate08", "=q3=Rune-Etched Breastplate", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
		{ "s47257", "inv_helmet_06", "=q3=Rune-Etched Crown", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
		{ "s47258", "INV_Shoulder_11", "=q3=Rune-Etched Mantle", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
...
--------------------
	...
	LeatherExpert2 = {
		...
		{ "s46620", "inv_boots_05", "=q2=Grifter's Boots", "=ds=#sr# =so1=200 =so2=220 =so3=230 =so4=240" },
		{ "s46621", "inv_gauntlets_15", "=q2=Grifter's Gauntlets", "=ds=#sr# =so1=200 =so2=220 =so3=230 =so4=240" },
		{ "s46622", "inv_belt_04", "=q2=Grifter's Belt", "=ds=#sr# =so1=200 =so2=220 =so3=230 =so4=240" },
		{ "s46623", "inv_pants_12", "=q2=Grifter's Leggings", "=ds=#sr# =so1=205 =so2=225 =so3=235 =so4=245" },
		...
		{ "s46624", "inv_chest_leather_08", "=q2=Grifter's Tunic", "=ds=#sr# =so1=210 =so2=230 =so3=240 =so4=250" },
		{ "s46625", "inv_helmet_33", "=q2=Grifter's Cover", "=ds=#sr# =so1=210 =so2=230 =so3=240 =so4=250" },
	...
	Dragonscale1 = {
		...
		{ "s54001", "INV_Boots_Chain_06", "=q3=Blue Dragonscale Boots", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
