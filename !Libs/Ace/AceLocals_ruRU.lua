...
ACE_NAME					= "Ace"
ACE_DESCRIPTION				= "Аддон разширения и управления инструментарием."
...
ACE_TEXT_ACE_REGISTERED		= "Зарегестрированные Асе приложения"
...
-- Addon locals
ACE_ADDON_LOADED			= "|cffffff78%s v%s|r |cffffffffby|r |cffd8c7ff%s|r |cffffffffis теперь загружен.|r"
...
ACE_CATEGORY_BATTLEGROUNDS	= "Поля сражений"
ACE_CATEGORY_CHAT			= "Чат/Коммуникация"
ACE_CATEGORY_CLASS			= "Улучшение класса"
...
ACE_CMD_OPTIONS				= {
	...
	},
	{
		...
		args	= {
			...
			{
				option	= "loadable",
				desc	= "Список всех аддоно которые доступны для загрузки.",
	...
	{
		option	= "load",
		desc	= "Загрузить аддон, если в данный момент он отключен и если он установлен для загрузки  "..
				  "по требованию.",
		input	= 1,
		method	= "LoadAddon",
		args	= {
			{
				option	= "auto",
				desc	= "Загрузить и установить аддон, чтобы он автоманически загружался при старте игры..",
