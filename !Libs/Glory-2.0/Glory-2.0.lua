...
elseif locale == "ruRU" then
	...
	PATTERN_HORDE_FLAG_CAPTURED = "(%a+) $gзахватил:захватила; [Фф]лаг Орды!"
	PATTERN_ALLIANCE_FLAG_PICKED_UP = "(%a+) $gподобрал:подобрала; [Фф]лаг Альянса!"
	PATTERN_ALLIANCE_FLAG_DROPPED = "(%a+) $gпотерял:потеряла; [Фф]лаг Альянса!"
	PATTERN_ALLIANCE_FLAG_CAPTURED = "(%a+) $gзахватил:захватила; [Фф]лаг Альянса!"
	
	FACTION_DEFILERS = "Осквернители"
	FACTION_FROSTWOLF_CLAN = "Клан Северного Волка"
	FACTION_WARSONG_OUTRIDERS = "Всадники Песни Войны"
	
	FACTION_LEAGUE_OF_ARATHOR = "Лига Аратора"
	FACTION_STORMPIKE_GUARD = "Стража Грозовой Вершины"
	FACTION_SILVERWING_SENTINELS = "Среброкрылые Часовые"
	
	BGObjectiveDescriptions = {
		ALLIANCE_CONTROLLED = "Под контролем Альянса",
		HORDE_CONTROLLED = "Под контролем Орды",
		IN_CONFLICT = "Оспаривается",
	...
	BGChatAnnouncements = {
		...
		BGObjectiveCapturedAnnouncements = {
			...
			PATTERN_OBJECTIVE_CAPTURED_AV1 = "^([%w ]+) был взят (%a+)",
