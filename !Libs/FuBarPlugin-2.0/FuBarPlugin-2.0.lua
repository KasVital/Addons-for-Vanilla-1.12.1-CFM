...
elseif GetLocale() == "esES" then
	...
	SHOW_ICON_DESC = "Muestra los iconos de los plugins al panel."
	SHOW_TEXT = "Mostrar texto"
	SHOW_TEXT_DESC = "Muestra el texto de los plugins al panel."
	SHOW_COLORED_TEXT = "Mostrar texto coloreado"
	SHOW_COLORED_TEXT_DESC = "Permitir que el plugin se colorea su texto."
	DETACH_TOOLTIP = "Separar tooltip"
	DETACH_TOOLTIP_DESC = "Separa el tooltip del panel."
	LOCK_TOOLTIP = "Bloquear tooltip"
	LOCK_TOOLTIP_DESC = "Bloquea la posición de los tooltips. Cuando el tooltip esté bloqueado, presiona Alt para accederlo con el puntero."
	POSITION = "Posición"
	POSITION_DESC = "Posicionar el plugin en el panel."
	POSITION_LEFT = "Izquierdo"
	POSITION_RIGHT = "Derecho"
	POSITION_CENTER = "Centro"
	ATTACH_TO_MINIMAP = "Fijar al minimapa"
	ATTACH_TO_MINIMAP_DESC = "Fija el plugin al minimapa en lugar del panel."
	HIDE_FUBAR_PLUGIN = "Ocultar plugin"
	HIDE_FUBAR_PLUGIN_CMD = "Ocultado"
	HIDE_FUBAR_PLUGIN_DESC = "Oculta el plugin del panel o minimapa y deja que el addon es activo."
