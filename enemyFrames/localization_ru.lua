...
EF_L_DASH='Порыв';
EF_L_DEMORALIZINGROAR='Деморализующий рев';
...
EF_L_SILITHIDPOX='Силитидова чума';
EF_L_SLOWINGPOISON='Замедляющий яд';
EF_L_TOXICSPIT='Токсичный плевок';
EF_L_TRALANESFREEZINGTOUCH='Леденящее касание Трелана';
EF_L_WANDERINGPLAGUE='Бродячая чума';
EF_L_WEAKFROSTBOLT='Слабая ледяная стрела';
EF_L_WITHERTOUCH='Касание увядания';
...
EF_L_PORTALDARNASSUS='Портал в Дарнас';
