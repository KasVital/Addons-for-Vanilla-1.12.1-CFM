	...
	SPELLINFO_BUFFS_TO_TRACK = {
		...
		[EF_L_CHILLED] 				= {['icon'] = [[Interface\Icons\Spell_frost_frostarmor02]], 		['duration'] = 7, 	['display'] = false,},
		...
		[EF_L_STORMSTRIKE]			= {['icon'] = [[Interface\Icons\Spell_holy_sealofmight]],			['duration'] = 12,	['display'] = true,},
		     ...
		     -- WARLOCK
		[EF_L_CORRUPTION]			= {['icon'] = [[Interface\Icons\Spell_shadow_abominationexplosion]],['duration'] = 18,	['display'] = false,},
		[EF_L_CURSEOFAGONY]			= {['icon'] = [[Interface\Icons\Spell_shadow_curseofsargeras]],		['duration'] = 24,	['display'] = false,},
		[EF_L_CURSEOFEXHAUSTION]	= {['icon'] = [[Interface\Icons\Spell_shadow_grimward]],			['duration'] = 30,	['display'] = true,		['type'] = 'curse',},
		[EF_L_CURSEOFTONGUES]		= {['icon'] = [[Interface\Icons\Spell_shadow_curseoftounges]],		['duration'] = 30,	['display'] = false,		['type'] = 'curse',},
		...
		[EF_L_REND]					= {['icon'] = [[Interface\Icons\Ability_gouge]], 					['duration'] = 21,	['display'] = false,},
