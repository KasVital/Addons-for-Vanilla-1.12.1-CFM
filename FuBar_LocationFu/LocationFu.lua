...
LocationFu.version = "2.0" .. string.sub("$Revision: 9539 $", 12, -3)
LocationFu.date = string.sub("$Date: 2006-08-30 00:40:08 -1000 (Wed, 30 Aug 2006) $", 8, 17)
...
local options = {
	...
	args = {
		...
		mapCoords = {
			type = 'toggle',
			name = L"Show coordinates on map",
