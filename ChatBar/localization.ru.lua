...
CHATBAR_MENU_MAIN_TITLE 			= "Настройки ChatBar";
...
CHATBAR_MENU_CHANNEL_STICKY			= "Липкие каналы";
CHATBAR_MENU_STICKY					= "Липкие";
...
CHATBAR_LFG					= "ПоискСпутников";
CHATBAR_LOCALDEFENSE		= "ОборонаЛокальный";
CHATBAR_WORLDDEFENSE		= "ОборонаГлобальный";
CHATBAR_GUILDRECRUITMENT	= "Гильдии";
end